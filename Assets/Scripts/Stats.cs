...
public class Stats : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LeanTween.moveLocal(gameObject.transform.GetChild(0).gameObject, new Vector3(0, -20, 0), 1.5f).setEase(LeanTweenType.easeInOutBack);
        LeanTween.scale(defeated.gameObject, new Vector3(1, 1, 1), 1.5f).setDelay(1.5f).setEase(LeanTweenType.easeOutBack);
